...
<head runat="server">
    ...
    <title>Show Management - KumariCinemas</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-box { background: white; padding: 24px; margin-bottom: 24px; border: 1px solid #ddd; border-radius: 8px; max-width: 540px; box-shadow: 0 1px 4px rgba(0,0,0,0.07); }
...
<body>
    <div class="navbar">
        ...
        <a href="ShowForm.aspx" class="active">Shows</a>
    ...
    <div class="page">
        ...
        <h2><i class="bi bi-film"></i> Show Management</h2>
        <asp:Label ID="lblMessage" runat="server" CssClass="msg-success" />

        <div class="form-box">
            <h3><asp:Label ID="lblFormTitle" runat="server" Text="Add New Show" /></h3>
            ...
            <div class="form-row">
                ...
                <asp:RequiredFieldValidator ControlToValidate="ddlMovie" runat="server"
                    InitialValue="0" ErrorMessage="Please select a movie."
            ...
            <div class="form-row">
                ...
                <asp:RequiredFieldValidator ControlToValidate="ddlHall" runat="server"
                    InitialValue="0" ErrorMessage="Please select a hall."
                    ForeColor="Red" Display="Dynamic" />
            </div>

            <div class="form-row">
                <label>Showtime *</label>
                <asp:DropDownList ID="ddlShowtime" runat="server" Width="100%" />
                <asp:RequiredFieldValidator ControlToValidate="ddlShowtime" runat="server"
                    InitialValue="0" ErrorMessage="Please select a showtime."
                    ForeColor="Red" Display="Dynamic" />
            </div>

            <div class="form-row">
                <label>Pricing *</label>
                <asp:DropDownList ID="ddlPricing" runat="server" Width="100%" />
                <asp:RequiredFieldValidator ControlToValidate="ddlPricing" runat="server"
                    InitialValue="0" ErrorMessage="Please select a pricing."
                    ForeColor="Red" Display="Dynamic" />
            </div>

            <div class="form-row">
                <label>Show Date *</label>
                <asp:TextBox ID="txtShowDate" runat="server" placeholder="e.g. 15-Jan-2025" />
        ...
        <asp:GridView ID="gvShows" runat="server"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="EditShow"
                            CommandArgument='<%# Eval("Show_Id") %>' CssClass="btn-edit"
                            Text='<i class="bi bi-pencil"></i> Edit' CausesValidation="false" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="DeleteShow"
                            CommandArgument='<%# Eval("Show_Id") %>' CssClass="btn-delete"
                            Text='<i class="bi bi-trash3-fill"></i> Delete'
                            OnClientClick="return confirm('Delete this show and all linked tickets?');"
