...
<head runat="server">
    ...
    <title>User Management - KumariCinemas</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-row input[type=text], .form-row input[type=password] { width: 100%; padding: 7px; border: 1px solid #ccc; border-radius: 4px; font-size: 0.9rem; }
        .form-row input[type=text]:focus, .form-row input[type=password]:focus { outline: none; border-color: #1B3A6B; }
...
<body>
    ...
    <div class="navbar">
        ...
        <a href="UserForm.aspx" class="active">Users</a>
    ...
    <div class="page">
        ...
        <h2><i class="bi bi-person-fill"></i> User Management</h2>

        <asp:Label ID="lblMessage" runat="server" CssClass="msg-success" />

        <!-- ── Form ── -->
        <div class="form-box">
            <h3><asp:Label ID="lblFormTitle" runat="server" Text="Add New User" /></h3>

            <asp:HiddenField ID="hfUserId" runat="server" Value="0" />

            <div class="form-row">
                <label>Username *</label>
                <asp:TextBox ID="txtUsername" runat="server" MaxLength="100" placeholder="e.g. Sita Sharma" />
            ...
            <div class="form-row">
                <label>Email *</label>
                <asp:TextBox ID="txtEmail" runat="server" MaxLength="150" placeholder="e.g. sita@gmail.com" />
            ...
            <div class="form-row">
                <label>Phone</label>
                <asp:TextBox ID="txtPhone" runat="server" MaxLength="20" placeholder="e.g. 9841234567" />
            </div>

            <div class="form-row">
                <label>Password *</label>
                <asp:TextBox ID="txtPassword" runat="server" MaxLength="255" TextMode="Password" placeholder="Enter password" />
            ...
            <div class="form-row">
                <label>Address</label>
                <asp:TextBox ID="txtAddress" runat="server" MaxLength="255" placeholder="e.g. Thamel, Kathmandu" />
            </div>
