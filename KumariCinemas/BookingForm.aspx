...
<head runat="server">
    ...
    <title>Booking Management - KumariCinemas</title>
    <style>
...
<body>
    ...
    <div class="navbar">
        ...
        <a href="BookingForm.aspx" class="active">Bookings</a>
    ...
    <div class="page">
        ...
        <h2><i class="bi bi-journal-bookmark-fill"></i> Booking Management</h2>

        <asp:Label ID="lblMessage" runat="server" CssClass="msg-success" />

        <!-- ── Form ── -->
        <div class="form-box">
            <h3><asp:Label ID="lblFormTitle" runat="server" Text="Add New Booking" /></h3>
            ...
            <div class="form-row">
                ...
                <asp:TextBox ID="txtBookingDate" runat="server" placeholder="e.g. 10-Jan-2025" />
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton runat="server"
                            ...
                            OnClientClick="return confirm('Delete this booking and all linked records?');"
                            CausesValidation="false" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
