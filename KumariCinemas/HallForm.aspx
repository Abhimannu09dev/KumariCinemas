...
<head runat="server">
    ...
    <title>Hall Management - KumariCinemas</title>
    <style>
...
<body>
    ...
    <div class="navbar">
        ...
        <a href="HallForm.aspx" class="active">Halls</a>
        <span class="nav-sep">|</span>
    ...
    <div class="page">
        ...
        <h2><i class="bi bi-building-fill"></i> Hall Management</h2>

        <asp:Label ID="lblMessage" runat="server" CssClass="msg-success" />

        <div class="form-box">
            <h3><asp:Label ID="lblFormTitle" runat="server" Text="Add New Hall" /></h3>

            <asp:HiddenField ID="hfHallId" runat="server" Value="0" />

            <div class="form-row">
                <label>Theater *</label>
                <asp:DropDownList ID="ddlTheater" runat="server" Width="100%" />
                <asp:RequiredFieldValidator ControlToValidate="ddlTheater" runat="server"
                    InitialValue="0"
                    ErrorMessage="Please select a theater." ForeColor="Red" Display="Dynamic" />
            </div>

            <div class="form-row">
                <label>Hall Name *</label>
                <asp:TextBox ID="txtHallName" runat="server" MaxLength="100" placeholder="e.g. Hall A" />
                <asp:RequiredFieldValidator ControlToValidate="txtHallName" runat="server"
                    ErrorMessage="Hall name is required." ForeColor="Red" Display="Dynamic" />
            </div>

            <div class="form-row">
                <label>Capacity (seats) *</label>
                <asp:TextBox ID="txtCapacity" runat="server" MaxLength="5" placeholder="e.g. 150" />
                ...
                <asp:RangeValidator ControlToValidate="txtCapacity" runat="server"
                    ...
                    ErrorMessage="Capacity must be between 1 and 2000." ForeColor="Red" Display="Dynamic" />
            </div>
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton runat="server"
                            ...
                            OnClientClick="return confirm('Delete this hall and all linked shows/tickets?');"
                            CausesValidation="false" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
