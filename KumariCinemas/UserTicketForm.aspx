<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserTicketForm.aspx.cs" Inherits="KumariCinemas.UserTicketForm" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css"/>
    <title>User Ticket Report - KumariCinemas</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .filter-field select, .filter-field input[type=text] { padding: 7px 10px; border: 1px solid #ccc; border-radius: 4px; font-size: 0.9rem; min-width: 200px; }
        .filter-field select:focus, .filter-field input[type=text]:focus { outline: none; border-color: #1B3A6B; }
        ...
        .msg-info    { color: #1B3A6B; font-weight: bold; margin: 10px 0; display: block; }
        ...
        .badge-paid     { background: #d5f5e3; color: #1e8449; padding: 2px 8px; border-radius: 10px; font-size: 0.78rem; font-weight: bold; }
        .badge-unpaid   { background: #fef9e7; color: #b7950b; padding: 2px 8px; border-radius: 10px; font-size: 0.78rem; font-weight: bold; }
        .badge-cancelled{ background: #fadbd8; color: #922b21; padding: 2px 8px; border-radius: 10px; font-size: 0.78rem; font-weight: bold; }
    </style>
</head>
<body>
    <div class="navbar">
        ...
        <span class="nav-sep">|</span>
        <a href="UserTicketForm.aspx" class="active">User Ticket</a>
    ...
    <div class="page">
        ...
        <h2><i class="bi bi-person-lines-fill"></i> User Ticket Report</h2>
        <div class="page-sub">Complex Query 1 — For any user, show details of the tickets they bought during a 6-month period.</div>

        <asp:Label ID="lblMessage" runat="server" CssClass="msg-info" />

        <div class="filter-box">
            <h3><i class="bi bi-funnel-fill"></i> Search Filters</h3>
            <div class="filter-row">
                ...
                <div class="filter-field">
                    ...
                    <asp:TextBox ID="txtDateFrom" runat="server" placeholder="e.g. 01-Aug-2024" />
                </div>
            ...
            <div style="margin-top:8px; font-size:0.82rem; color:#888;">
                <i class="bi bi-info-circle"></i> Results show all <strong>Paid</strong> tickets from the From Date up to 6 months ahead.
            </div>
        </div>
        ...
        <asp:GridView ID="gvResults" runat="server"
            ...
            CssClass="grid-style"
            EmptyDataText="No paid tickets found for this user in the selected 6-month period."
            Visible="false">
            <Columns>
