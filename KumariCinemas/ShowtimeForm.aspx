<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowtimeForm.aspx.cs" Inherits="KumariCinemas.ShowtimeForm" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css"/>
    <title>Showtime Management - KumariCinemas</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-row input[type=text] { width: 100%; padding: 7px; border: 1px solid #ccc; border-radius: 4px; font-size: 0.9rem; }
...
<body>
    <div class="navbar">
        ...
        <span class="nav-sep">|</span>
        <a href="ShowtimeForm.aspx" class="active">Showtimes</a>
    ...
    <div class="page">
        <h2><i class="bi bi-clock-fill"></i> Showtime Management</h2>
        <asp:Label ID="lblMessage" runat="server" CssClass="msg-success" />

        <div class="form-box">
            <h3><asp:Label ID="lblFormTitle" runat="server" Text="Add New Showtime" /></h3>
            <asp:HiddenField ID="hfShowtimeId" runat="server" Value="0" />

            <div class="form-row">
                <label>Showtime Name *</label>
                <asp:TextBox ID="txtShowtimeName" runat="server" MaxLength="50" placeholder="e.g. Morning (10:00 AM)" />
                <asp:RequiredFieldValidator ControlToValidate="txtShowtimeName" runat="server"
                    ErrorMessage="Showtime name is required." ForeColor="Red" Display="Dynamic" />
            </div>

            <br />
            <asp:Button ID="btnSave"  runat="server" Text="Save Showtime"  CssClass="btn-save"  OnClick="btnSave_Click" />
        ...
        <asp:GridView ID="gvShowtimes" runat="server"
            ...
            OnRowCommand="gvShowtimes_RowCommand">
            <Columns>
                <asp:BoundField DataField="Showtime_Id"   HeaderText="ID"       />
                <asp:BoundField DataField="Showtime_Name" HeaderText="Showtime" />
                <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="EditShowtime"
                            CommandArgument='<%# Eval("Showtime_Id") %>' CssClass="btn-edit"
                            Text='<i class="bi bi-pencil"></i> Edit' CausesValidation="false" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="DeleteShowtime"
                            CommandArgument='<%# Eval("Showtime_Id") %>' CssClass="btn-delete"
                            Text='<i class="bi bi-trash3-fill"></i> Delete'
                            OnClientClick="return confirm('Delete this showtime?');" CausesValidation="false" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
