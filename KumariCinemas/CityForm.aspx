<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CityForm.aspx.cs" Inherits="KumariCinemas.CityForm" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css"/>
    <title>City Management - KumariCinemas</title>
    <style>
...
<body>
    <div class="navbar">
        ...
        <a href="CityForm.aspx" class="active">Cities</a>
    ...
    <div class="page">
        <h2><i class="bi bi-geo-alt-fill"></i> City Management</h2>
        <asp:Label ID="lblMessage" runat="server" CssClass="msg-success" />

        <div class="form-box">
            <h3><asp:Label ID="lblFormTitle" runat="server" Text="Add New City" /></h3>
            <asp:HiddenField ID="hfCityId" runat="server" Value="0" />

            <div class="form-row">
                <label>City Name *</label>
                <asp:TextBox ID="txtCityName" runat="server" MaxLength="100" placeholder="e.g. Kathmandu" />
                <asp:RequiredFieldValidator ControlToValidate="txtCityName" runat="server"
                    ErrorMessage="City name is required." ForeColor="Red" Display="Dynamic" />
            </div>

            <br />
            <asp:Button ID="btnSave"  runat="server" Text="Save City"  CssClass="btn-save"  OnClick="btnSave_Click" />
        ...
        <asp:GridView ID="gvCities" runat="server"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="EditCity"
                            CommandArgument='<%# Eval("City_Id") %>' CssClass="btn-edit"
                            Text='<i class="bi bi-pencil"></i> Edit' CausesValidation="false" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="DeleteCity"
                            CommandArgument='<%# Eval("City_Id") %>' CssClass="btn-delete"
                            Text='<i class="bi bi-trash3-fill"></i> Delete'
                            OnClientClick="return confirm('Delete this city?');" CausesValidation="false" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
