...
<head runat="server">
    ...
    <title>Ticket Management - KumariCinemas</title>
    <style>
...
<body>
    <div class="navbar">
        ...
        <a href="TicketForm.aspx" class="active">Tickets</a>
        <span class="nav-sep">|</span>
    ...
    <div class="page">
        ...
        <h2><i class="bi bi-ticket-fill"></i> Ticket Management</h2>
        <asp:Label ID="lblMessage" runat="server" CssClass="msg-success" />

        <div class="form-box">
            <h3><asp:Label ID="lblFormTitle" runat="server" Text="Add New Ticket" /></h3>
            ...
            <div class="form-row">
                ...
                <asp:RequiredFieldValidator ControlToValidate="ddlUser" runat="server"
                    InitialValue="0" ErrorMessage="Please select a user."
            ...
            <div class="form-row">
                ...
                <asp:RequiredFieldValidator ControlToValidate="ddlShow" runat="server"
                    InitialValue="0" ErrorMessage="Please select a show."
                    ForeColor="Red" Display="Dynamic" />
            </div>

            <div class="form-row">
                <label>Seat Number *</label>
                <asp:TextBox ID="txtSeatNumber" runat="server" MaxLength="10" placeholder="e.g. A1" />
            ...
            <div class="form-row">
                ...
                <asp:DropDownList ID="ddlPaymentStatus" runat="server" Width="100%">
                ...
                <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="EditTicket"
                            CommandArgument='<%# Eval("Ticket_Id") %>' CssClass="btn-edit"
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="DeleteTicket"
                            CommandArgument='<%# Eval("Ticket_Id") %>' CssClass="btn-delete"
