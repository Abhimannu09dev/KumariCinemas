<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PricingForm.aspx.cs" Inherits="KumariCinemas.PricingForm" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css"/>
    <title>Pricing Management - KumariCinemas</title>
    <style>
...
<body>
    <div class="navbar">
        ...
        <a href="PricingForm.aspx" class="active">Pricing</a>
    ...
    <div class="page">
        <h2><i class="bi bi-tag-fill"></i> Pricing Management</h2>
        <asp:Label ID="lblMessage" runat="server" CssClass="msg-success" />

        <div class="form-box">
            <h3><asp:Label ID="lblFormTitle" runat="server" Text="Add New Pricing" /></h3>
            <asp:HiddenField ID="hfPricingId" runat="server" Value="0" />

            <div class="form-row">
                <label>Ticket Price (NPR) *</label>
                <asp:TextBox ID="txtTicketPrice" runat="server" MaxLength="10" placeholder="e.g. 300.00" />
                <asp:RequiredFieldValidator ControlToValidate="txtTicketPrice" runat="server"
                    ErrorMessage="Ticket price is required." ForeColor="Red" Display="Dynamic" />
                <asp:RangeValidator ControlToValidate="txtTicketPrice" runat="server"
                    MinimumValue="1" MaximumValue="99999" Type="Double"
                    ErrorMessage="Price must be between 1 and 99999." ForeColor="Red" Display="Dynamic" />
            </div>

            <div class="form-row">
                <label>Is Holiday Pricing? *</label>
                <asp:DropDownList ID="ddlHoliday" runat="server" Width="100%">
                    <asp:ListItem Value="N">No — Regular Price</asp:ListItem>
                    <asp:ListItem Value="Y">Yes — Holiday Price</asp:ListItem>
                </asp:DropDownList>
            </div>

            <br />
            <asp:Button ID="btnSave"  runat="server" Text="Save Pricing"  CssClass="btn-save"  OnClick="btnSave_Click" />
        ...
        <asp:GridView ID="gvPricing" runat="server"
            ...
            CssClass="grid-style"
            EmptyDataText="No pricing records found."
            OnRowCommand="gvPricing_RowCommand">
            <Columns>
                <asp:BoundField DataField="Pricing_Id"       HeaderText="ID"              />
                <asp:BoundField DataField="Ticket_Price"     HeaderText="Price (NPR)"     DataFormatString="{0:N2}" />
                <asp:BoundField DataField="IsHolidayPricing" HeaderText="Holiday Pricing" />
                <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="EditPricing"
                            CommandArgument='<%# Eval("Pricing_Id") %>' CssClass="btn-edit"
                            Text='<i class="bi bi-pencil"></i> Edit' CausesValidation="false" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="DeletePricing"
                            CommandArgument='<%# Eval("Pricing_Id") %>' CssClass="btn-delete"
                            Text='<i class="bi bi-trash3-fill"></i> Delete'
                            OnClientClick="return confirm('Delete this pricing record?');" CausesValidation="false" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
